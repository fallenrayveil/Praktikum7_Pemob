...
import 'package:shared_preferences/shared_preferences.dart'; //import sharedpref
...
class MyApp extends StatefulWidget {
  ...
  @override
  State<MyApp> createState() => _MyAppState(); //inisialisasi state
}

class _MyAppState extends State<MyApp> { //class state
  late Future<String> userId; //inisialisasi future
